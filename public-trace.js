...
function renderTimeline(data) {
    ...
    data.forEach((item, index) => {
        ...
        if (!farmShown && rec.harvestDate) {
            ...
            metaHtml = `<p class="text-[11px] text-gray-500 mt-1 font-medium">Retail packaging confirmed.</p>`;
            ...
            if (status === 'IN_TRANSIT') {
                ...
                metaHtml = `<p class="text-[11px] text-gray-400 mt-1 font-medium uppercase">Received by ${rec.ownerName}</p>`;
            }
        }
